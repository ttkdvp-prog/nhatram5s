          ...
          <div>
            ...
            <div className="flex space-x-2">
              <button
                ...
                className={`flex-1 py-2 rounded-xl text-xs font-bold transition-all ${pasteType === 'Trước'
              ...
              <button
                ...
                className={`flex-1 py-2 rounded-xl text-xs font-bold transition-all ${pasteType === 'Sau'
